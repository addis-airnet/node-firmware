...
bool gsm_init_http() {
  ...
  // Firebase REST API usually accepts standard JSON content type
  gsm_send_at("AT+HTTPPARA=\"CONTENT\",\"application/json\"", 1000);

  // Note: Firebase doesn't use X-Device-ID headers by default. 
  // You should move device identification INSIDE the JSON payload instead.
